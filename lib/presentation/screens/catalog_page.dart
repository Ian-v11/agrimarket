              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ListView(
                    ...
                    children: [
                      // === Popup de Categoría (igual que antes) ===
                      ...
                      // === BOTÓN "Todo" que navega a la pantalla de Categorías ===
                      GestureDetector(
                        onTap: () async {
                          // Navega a CategoriesPage y espera una selección (String con el nombre)
                          final selected = await Navigator.of(context).push<String?>(
                            MaterialPageRoute(builder: (_) => const CategoriesPage()),
                          );

                          // Si el usuario selecciona una categoría, aplica el filtro en el catálogo
                          if (selected != null && selected.isNotEmpty) {
                            context.read<CatalogBloc>().add(CatalogCategoryChanged(selected));
                          }
                        },
                        child: Container(
                          ...
                          child: const Row(
                            ...
                            children: [
                              ...
                              SizedBox(width: 8),
                              Text('Todo', style: TextStyle(fontWeight: FontWeight.w600)),
                            ],
                          ),
                        ),
                      ),
